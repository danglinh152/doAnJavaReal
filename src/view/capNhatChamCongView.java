...
import controller.capNhatChamCongController;
...
//		maCC.setVisible(false);
		...
		headerLabel.setBounds(10, 10, 273, 30);
		...
		maNVTF.setText(String.valueOf(chamCongClass.getMaNV()));
		...
		soNgayLamViecTF.setText(String.valueOf(chamCongClass.getSoNgayLamViec()));
		...
		soNgayNghiTF.setText(String.valueOf(chamCongClass.getSoNgayNghi()));
		...
		soGioTangCaTF.setText(String.valueOf(chamCongClass.getSoGioTangCa()));
		...
		soNgayDiTreTF.setText(String.valueOf(chamCongClass.getSoNgayDiTre()));
		...
		thangLamViecTF.setText(String.valueOf(chamCongClass.getThangLamViec()));
	...
	public JTextField getMaCC() {
		return maCC;
	}

	public void setMaCC(JTextField maCC) {
		this.maCC = maCC;
	}
