...
public class capNhatTaiKhoanView extends JDialog {
	...
	public capNhatTaiKhoanView(taiKhoan taiKhoan) {
		...
		maNVTF.setText(String.valueOf(taiKhoan.getMaTK()));
		...
		String loaiTK[] = { "quản lý", "nhân viên" };
		loaiTKComboBox = new JComboBox(loaiTK);
		loaiTKComboBox.setFont(new Font("Tahoma", Font.PLAIN, 12));
		loaiTKComboBox.setBounds(210, 236, 77, 21);
		if (taiKhoan.getLoaiTK().equals("quản lý")) {
			loaiTKComboBox.setSelectedItem("quản lý");
		} else {
			loaiTKComboBox.setSelectedItem("nhân viên");
		}
	...
	public JComboBox getLoaiTKComboBox() {
		return loaiTKComboBox;
	}

	public void setLoaiTKComboBox(JComboBox loaiTKComboBox) {
		this.loaiTKComboBox = loaiTKComboBox;
	}
