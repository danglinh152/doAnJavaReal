...
import controller.capNhatNhanVienController;
import controller.capNhatThongTinNhanVienController;
...
public class capNhatThongTinViewNhanVien extends JDialog {
	...
	public capNhatThongTinViewNhanVien(taiKhoanViewNhanVien taiKhoanViewNhanVien_ref, nhanVien nhanVien) {
		...
		tenNVTF.setText(nhanVien.getHoTen());
		...
		ngSinhTF.setText(String.valueOf(nhanVien.getNgSinh()));
		...
		sdtTF.setText(nhanVien.getSoDienThoai());
		formPanel.add(sdtTF);
		...
		emailTF.setText(nhanVien.getEmail());
		...
		cccdTF.setText(nhanVien.getCccd());
		...
		if (nhanVien.getCapBac().endsWith("Fresher")) {
			capBacComboBox.setSelectedIndex(0);
		} else if (nhanVien.getCapBac().equals("Junior")) {
			capBacComboBox.setSelectedIndex(1);
		} else if (nhanVien.getCapBac().equals("Senior")) {
		...
		this.addComponentListener(new ComponentListener() {
			...
			public void componentHidden(ComponentEvent e) {
				...
				mainViewNhanVien mainViewNhanVien = new mainViewNhanVien(
						taiKhoanViewNhanVien.getMainViewNhanVien().getTaiKhoanHienTai());
