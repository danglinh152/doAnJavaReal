...
public class thongTinViewNhanVien {
	public JPanel tab7;
	...
	public thongTinViewNhanVien(mainViewNhanVien mainViewNhanVien) {

		this.mainViewNhanVien = mainViewNhanVien;
		ac = new thongTinNhanVienController(this);
		ke = new thongTinNhanVienController(this);
